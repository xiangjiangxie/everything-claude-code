...
### 2. 分析模块
对每个模块：提取导出、映射导入、识别路由、查找数据库模型、定位 worker
...
**始终：** 新的主要功能、API 路由变更、依赖添加/移除、架构变更、设置流程修改。

**可选：** 小型 bug 修复、外观变更、内部重构。

---

**切记**：与现实不匹配的文档比没有文档更糟糕。始终从数据源生成。
