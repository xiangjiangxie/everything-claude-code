...
> 本文件以 Kotlin 和 Android/KMP 特定内容扩展了 [common/testing.md](../common/testing.md)。
...
├── androidInstrumentedTest/kotlin/  # 仪器测试（Room、UI）
└── iosTest/kotlin/        # iOS 特定测试
```

最低测试覆盖要求：每个功能的 ViewModel + UseCase。
